...
Public Class Adherencia
    ...
    Private Sub Adherencia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    End Sub

    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        Dim fecha As String = TextBox1.Text
        Dim fecha1 As String = TextBox2.Text
        Dim consulta As String = "SELECT Usuario,CONVERT(VARCHAR(10),Fecha, 103) as Fecha, SUBSTRING (convert(char(38),Hora_Inicio ,121),12,8)as ' Hora de Logueo',SUBSTRING (convert(char(38),Hora_Fin ,121),12,8)as 'Hora de Deslogueo', SUBSTRING (convert(char(38),Hora_Fin-Hora_Inicio ,121),12,8)as ' Total Tiempo'  FROM ADHERENCIA where (((ADHERENCIA.Fecha) Between '" & fecha & "' And '" & fecha1 & "'))"
