...
Public Class Reporte_Escalamientos
    ...
    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        ...
        Dim consulta As String = "SELECT CONVERT(VARCHAR(10),Fecha_Escalamiento , 103)as 'Fecha de Gestion',Usuario_Escala,Cuenta,Area,Motivo,Usuario,Estado from ESCALAMIENTOS where (((ESCALAMIENTOS.Fecha_Escalamiento) Between '" & fechaini & "' And '" & fechafin & "'));"
