...
Public Class Estado_Desconexiones
    ...
    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        ...
        Dim consulta As String = "select Usuario,CONVERT(VARCHAR(10),Fecha_Gestion , 103)as 'Fecha_Gestion',SUBSTRING (convert(char(38),Hora_Gestion,121),12,8)as 'Hora de Gestion',Cuenta ,Motivo_DX ,Codigo ,Nota1 ,Nota2 ,Nota3 ,Nota4 ,Nota5 ,Red ,Servicios ,Fecha_Solicitud ,Fecha_Corte ,Fecha_Preaviso ,Dia_DX as 'Dia de Desconexion',Gestion ,Razon ,Movie_Letter ,Ajuste ,Cantidad_Servicios ,Observaciones    from DESCONEXIONES where  (((DESCONEXIONES.Fecha_Gestion) Between '" & fechaini & "' And '" & fechafin & "'));"
