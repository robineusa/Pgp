...
Public Class Reporte_Casos_Vencidos
    ...
    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        ...
        Dim consulta As String = "SELECT CONVERT(VARCHAR(10),Fecha_Gestion , 103)as 'Fecha_Gestion',SUBSTRING (convert(char(38),Hora_Gestion,121),12,8)as 'Hora de Gestion',Usuario,Cuenta ,Numero_Ticket ,Fecha_Escalamiento ,Marca ,Motivo_Rec ,Usu_Retencion ,Ofrec_Ret ,Fecha_sol_can ,Movie_Letter ,Numero_Ser ,Ajuste ,Estado_Ticket ,Usuario_Escala ,Observaciones   from CASOS_VENCIDOS ,USUARIOS  where CASOS_VENCIDOS.Id_Usuario =USUARIOS .Id_Usuario and  CONVERT(VARCHAR(10),Fecha_Gestion , 103) between '" & fechaini & "' and '" & fechafin & "'"
