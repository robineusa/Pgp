...
Public Class Servicios_Pendientes_Dx
    ...
    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        Dim consulta As String = "SELECT TIPO_RECLAMACION, SUM(Cantidad_Servicios) AS 'TOTAL' FROM ASIG_TICKETS GROUP BY TIPO_RECLAMACION ORDER BY TOTAL DESC"
