...
Public Class Servicios_Desconectados
    ...
    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        ...
        Dim consulta As String = "select NOMBRE_GESTION, sum(SERVICIOS_DX)as 'Total Desconectados'  from CONSOLIDADO,GESTIONES  where  CONSOLIDADO.ID_GESTION = GESTIONES .ID_GESTION and (((CONSOLIDADO.FECHA_GESTION) Between '" & fechaini & "' And '" & fechafin & "')) group by NOMBRE_GESTION"
