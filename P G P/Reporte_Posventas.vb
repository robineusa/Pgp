...
Public Class Reporte_Posventas
    ...
    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        ...
        Dim consulta As String = "SELECT CONVERT(VARCHAR(10),Fecha_Gestion , 103)as 'Fecha_Gestion',SUBSTRING (convert(char(38),Hora_Gestion,121),12,8)as 'Hora de Gestion',Usuario,Cuenta ,Orden ,Rango_Dias ,Tipo_Trabajo,Usu_Creacion ,Fecha_Creacion ,Estado_Orden ,Tipo_Orden ,Motivo_Orden ,Num_Servicios ,Observaciones   from POSVENTAS where (((POSVENTAS.Fecha_Gestion) Between '" & fechaini & "' And '" & fechafin & "'))"
