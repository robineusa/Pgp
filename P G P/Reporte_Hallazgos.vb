...
Public Class Reporte_Hallazgos
    ...
    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        ...
        Dim consulta As String = "select Usuario ,Cuenta ,Tipo_Error ,Motivo_Error ,CONVERT(VARCHAR(10),Fecha , 103)as 'Fecha del Hallazgo', SUBSTRING (convert(char(38),Hora,121),12,8)as 'Hora del Hallazgo', Cantidad_Servicios ,Estado  from HALLAZGOS WHERE (((HALLAZGOS.Fecha) Between '" & fechaini & "' And '" & fechafin & "')) order by Usuario asc , Fecha desc"
