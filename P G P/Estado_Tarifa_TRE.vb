...
Public Class Estado_Tarifa_TRE
    ...
    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        ...
        Dim consulta As String = "SELECT Usuario,CONVERT(VARCHAR(10),Fecha_Gestion , 103)as 'Fecha_Gestion',SUBSTRING (convert(char(38),Hora_Gestion,121),12,8)as 'Hora de Gestion',Cuenta ,Gestion,Razon,Movie_Letter, Ajuste,Cant_Servicios,Observaciones from TARIFA_TRE where  (((TARIFA_TRE.Fecha_Gestion) Between '" & fechaini & "' And '" & fechafin & "'));"
