...
Public Class Tickets_DX
    Dim ID_MACROPROCESO = 9
    Private Sub Tickets_DX_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        consulta2 = "SELECT * FROM ASIG_TICKETS WHERE TIPO_RECLAMACION='Proceso Desconexiones' ORDER BY FECHA_CREACION ASC"
    ...
    Private Sub Cerrar_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        Else
            ...
            Dim Nota4 As String = TextBox13.Text
            Dim Nota5 As String = TextBox14.Text
            Dim Tipo_Reclamacion = "Proceso Desconexiones"
