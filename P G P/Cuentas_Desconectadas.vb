...
Public Class Cuentas_Desconectadas
    ...
    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        ...
        Dim consulta As String = "select Nombre_Gestion ,COUNT(Cuenta )AS 'Cantida Cuentas Dx'  from CONSOLIDADO INNER JOIN GESTIONES ON CONSOLIDADO .Id_Gestion = GESTIONES .Id_Gestion and  Servicios_Dx > 0  and (((CONSOLIDADO.Fecha) Between '" & fechaini & "' And '" & fechafin & "'))group by Nombre_Gestion"
